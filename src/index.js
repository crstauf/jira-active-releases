export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // Common links for all formats
      const basePath = url.pathname;
      const htmlUrl = basePath;
...
<head>
  ...
  <style>
    ...
    .updated { margin-bottom: 4px; font-size: 0.85em; }
    .force { color: #de350b; font-weight: 600; margin-top: 4px; display: inline-block; }
...
<body>
  ...
  <div class="footer">
    <p>Generated by <a href="${repoUrl}">jira-active-releases</a></p>
...
`;
        ...
        md += `Updated: ${now} UTC • `;
        md += `[View as HTML](${htmlUrl}) • [View as JSON](${jsonUrl})`;
        ...
        const jsonResponse = {
          _meta: {
            ...
            source: repoUrl,
            formats: {
              html: `https://${url.host}${htmlUrl}`,
              markdown: `https://${url.host}${mdUrl}`,
              json: `https://${url.host}${jsonUrl}`
            }
          },
